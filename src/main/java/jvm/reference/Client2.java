...
/**
 * Created by chenyun on 2020/4/17.
 */
public class Client2 {
    public static void main(String[] args) {
        ...
        WeakReference<Apple> appleWeakReference2 = new WeakReference<>(new Apple("紫苹果"), appleReferenceQueue);
        ...
        while ((reference2 = appleReferenceQueue.poll()) != null ) {
            //如果使用继承的方式就可以包含其他信息了
            System.err.println("appleReferenceQueue中：" + reference2);
        }
    }
}
